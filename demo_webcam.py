...
def get_features(landmarks, prev_pos, dt):
    """Extrait les features depuis les landmarks dans le format raw du dataset."""
    return extract_pressure_features(landmarks, prev_pos, dt)
        ...
        while cap.isOpened():
            ...
            if results.multi_hand_landmarks:
                ...
                for landmarks, handedness in zip(
                    ...
                    # Prediction: si le modèle casse, on garde la dernière classe
                    # connue et un niveau de confiance nul au lieu de continuer sans label.
                    pclass = 0
                    conf = 0.0
                    try:
                        ...
                        print(f"[WARN] Prediction ignored: {exc}")
                        pclass = 0
                        conf = 0.0
